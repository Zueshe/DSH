/**
 * Usage Statistics settings section: range presets, summary cards, a per-day
 * bar list, and a per-task table with a search filter. Data arrives through
 * the injected `load` callback; all interaction state is component-local.
 */
