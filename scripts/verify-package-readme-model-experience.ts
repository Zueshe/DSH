...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/session/session-usage': { kind: 'none', reason: 'The aggregation route folds already-logged provider usage into a read-only report and registers nothing model-facing.' },
