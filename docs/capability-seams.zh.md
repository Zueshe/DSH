...
flowchart LR
  ...
  svc_computerUse["ctx.computerUse<br/>Computer-use surface"]
  pkg_computer_use_playwright["computer-use-playwright"]
  ...
  pkg_computer_use_playwright --> svc_computerUse
...
| `ctx.computerUse` | `seam` | [`computer-use`](../packages/computer/computer-use) | [`computer-use-playwright`](../packages/computer/computer-use-playwright) | [`tool-computer-use`](../packages/computer/tool-computer-use) | - | 单一提供方供给共享可控界面；tool-computer-use 拥有面向模型的名称，并将观察结果附加为持久图片。 |
