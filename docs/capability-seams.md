...
| `ctx.computerUse` | `seam` | [`computer-use`](../packages/computer/computer-use) | [`computer-use-playwright`](../packages/computer/computer-use-playwright) | [`tool-computer-use`](../packages/computer/tool-computer-use) | - | One provider supplies the shared controllable surface; tool-computer-use owns the model-facing name and attaches observations as durable images. |
